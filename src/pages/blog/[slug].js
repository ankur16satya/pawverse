...
export default function BlogPost({ blog: initialBlog }) {
  ...
  const articleSchema = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `https://pawversesocial.com/blog/${blog.slug}`
    },
    "url": `https://pawversesocial.com/blog/${blog.slug}`,
    "inLanguage": "en-IN",
    "keywords": blog.category ? `${blog.category}, pet care, PawVerse blog` : 'pet care, PawVerse blog'
  }
  ...
  return (
    <div style={{ background: '#fff', minHeight: '100vh', paddingBottom: 100 }}>
      <SEO 
        ...
        description={blog.excerpt || `Read about ${blog.title} on the PawVerse pet care blog.`}
...
// Issue 2.2: SSR for blog posts — Googlebot reads full title/description/schema
